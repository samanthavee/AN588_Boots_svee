...
intercept_boots <- list(Mean = mean_intercept, SD = sd_intercept, 
                        UpperCI = upper_intercept, LowerCI = as.numeric(lower_intercept))
